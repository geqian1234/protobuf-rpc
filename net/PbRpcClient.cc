...
void PbRpcClient::connect()
{
 ...
 void PbRpcClient::handle_rpcserver_address_change(const std::string& path, const std::string& new_value)
 {

 }
    void PbRpcClient::handle_rpcserver_node_change(const std::string& path, const std::vector<std::string>& new_children)
    {
